"""
URL configuration for seek project.
...
schema_view = get_schema_view(
    openapi.Info(
        ...
        contact=openapi.Contact(email="contact@jpgonzalez.info"),
...
urlpatterns = [
    ...
    path('redoc-ui/', schema_view.with_ui('redoc', cache_timeout=0), name='schema-redoc'),
]
